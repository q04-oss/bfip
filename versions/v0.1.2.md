...
This is the foundation for the mesh network extension (see extensions/mesh.md).
...
A business beacon is a node in the Box Fraise mesh network. As the mesh protocol matures (see extensions/mesh.md), business beacons relay presence events, validate neighboring beacons, and enable offline verification. The value of a business's beacon participation increases as the network grows — Metcalfe's law applied to physical infrastructure.
